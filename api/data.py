# Store questions directly in the code for serverless environment
# This avoids file system access issues in serverless functions

def get_questions():
    """
    Return the list of programming-related questions for the game.
    In a serverless environment, we can't rely on reading from the filesystem
    at runtime, so we embed the questions directly in the code.
    """
    return [
